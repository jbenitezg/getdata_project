...
ORIGINAL DATASET (and I quote the below):
...
I quote the following information about the original datasets:
...
- label appropriately the columns to avoid duplicates
-  transform the activities ID value to the corresponding name of each activity
- extract mean and sd values(note this is not important for the final tidy data)
